...
public:
	...
	void						setDepthFilePath(const char *depth_file_path);
private:
    ...
    /// </summary>
    /// <returns>S_OK on success, otherwise failure code</returns>
	HRESULT						GetKinectFrames(bool &colorSynchronized, bool& is_eof);
	...
	FILE*						m_pDepthFilePtr;
	FILE*						m_pCameraPosePtr;
	matrix4x4f					m_trans_v1_to_v2;
};
